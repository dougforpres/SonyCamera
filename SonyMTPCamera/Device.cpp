...
Device::Clone()
{
    LOGTRACE(L"Device::Clone of %s", GetFriendlyName().c_str());
...
Device::Open()
{
    ...
    LOGTRACE(L"Out: Device::Open - now open %d times with handle x%08x", m_openCount, (DWORD)m_handle);
...
Device::GetFriendlyName()
{
    ...
    {
        LOGTRACE(L"In: Device::GetFriendlyName");
        ...
        LOGTRACE(L"Out: Device::GetFriendlyName - returning '%s'", m_friendlyName.c_str());
    }
...
Device::GetManufacturer()
{
    ...
    {
        LOGTRACE(L"In: Device::GetManufacturer");
        ...
        LOGTRACE(L"Out: Device::GetManufacturer - returning '%s'", m_manufacturer.c_str());
    }
...
Device::GetDescription()
{
    ...
    {
        LOGTRACE(L"In: Device::GetDescription");
        ...
        LOGTRACE(L"Out: Device::GetDescription - returning '%s'", m_description.c_str());
    }
...
void
Device::CreateClientInformation()
{
    if (!m_clientInformation)
    {
        LOGTRACE(L"In: Device::CreateClientInformation");
...
Message*
Device::InternalSend(Device::Op kind, Message* out)
{
    LOGTRACE(L"In: Device::InternalSend");
    ...
    LOGTRACE(L"Out: Device::InternalSend");

    return result;
}

bool
Device::Send(Message* out)
{
    LOGTRACE(L"In: Device::Send");
...
Message*
Device::Receive(Message* out)
{
    LOGTRACE(L"In: Device::Receive");

    Message *result = InternalSend(Op::ReceiveData, out);

    LOGTRACE(L"Out: Device::Receive");

    return result;
}

bool
Device::IsSuccess(HRESULT hr, const wchar_t * message)
{
